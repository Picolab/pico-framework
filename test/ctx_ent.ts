...
test("ctx.getEnt, ctx.putEnt, ctx.delEnt", async function(t) {
  ...
  t.is(await event("getEnt", ["foo"]), undefined);
  ...
  t.is(await pico.getEnt("rid.ctx", "some"), undefined);
  t.is(await pico.getEnt("rid.other", "some"), undefined);
  t.is(await subPico.getEnt("rid.ctx", "some"), undefined);
  t.is(await subPico.getEnt("rid.other", "some"), undefined);
